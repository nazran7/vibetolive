...
export const seoPagesData = {
	...
	'from-lovable-to-production': {
		en: {
			...
			metaTitle: 'From Lovable to Production | Make Your Lovable App Production-Ready',
			metaDescription: 'Turn your Lovable-built apps into secure, scalable, production-ready products. VibeToLive.dev helps founders make Lovable apps production-ready—without rewrites, instability, or launch risk.',
			metaKeywords: ['Lovable', 'Lovable app', 'production-ready', 'Lovable to production', 'AI apps', 'production deployment'],
			featuredImage: '/img3.png',

			// Hero Section
			pageTitle: 'From Lovable to Production — Make Your Lovable App Production-Ready',
			heroTitle: 'From Lovable to Production — Make Your Lovable App Production-Ready',
			heroSubtitle: 'Lovable helps you build fast. Production demands more. VibeToLive.dev helps founders turn Lovable-built apps into secure, scalable, production-ready products—without rewrites, instability, or launch risk.',
			heroImage: '/img3.png',
			showTechIcons: true,
			ctaLink: '#pricing',
			secondaryCtaLink: 'https://tally.so/r/mVry2j',
			...
			faqList: [
				{
					question: 'Do you rewrite Lovable apps from scratch?',
					answer: 'No. We keep working logic and fix only what blocks production.',
				},
				{
					question: 'How long does Lovable-to-production take?',
				...
				{
					question: 'What if my app needs major changes?',
					answer: 'We\'ll explain the options clearly before proceeding.',
				},
			],

			// CTA Section
			ctaHeadline: 'Ready to Make Your Lovable App Production-Ready?',
			ctaSubtext: 'Let\'s talk. Share your Lovable app, repo, and launch plans. We\'ll map the right path and help you ship with confidence—without slowing you down.',
			ctaButton: 'Get Started',
			secondaryCtaButton: 'Make My Lovable App Production-Ready',
		},
		zh: {
			slug: 'from-lovable-to-production',
	...
	'from-v0-to-production': {
		en: {
			...
			metaTitle: 'From v0 to Production | Make Your v0 App Production-Ready',
			metaDescription: 'Turn your v0-built apps into secure, scalable, production-ready products. VibeToLive.dev helps founders make v0 apps production-ready—without rewrites, brittle logic, or launch risk.',
			metaKeywords: ['v0', 'v0 app', 'production-ready', 'v0 to production', 'AI apps', 'production deployment'],
			featuredImage: '/img3.png',

			// Hero Section
			pageTitle: 'From v0 to Production — Make Your v0 App Production-Ready',
			heroTitle: 'From v0 to Production — Make Your v0 App Production-Ready',
			heroSubtitle: 'v0 helps you generate interfaces fast. Production demands reliability. VibeToLive.dev helps founders turn v0-built apps into secure, scalable, production-ready products—without rewrites, brittle logic, or launch risk.',
			heroImage: '/img3.png',
			showTechIcons: true,
			ctaLink: '#pricing',
			secondaryCtaLink: 'https://tally.so/r/mVry2j',
			...
			faqList: [
				{
					question: 'Do you rewrite v0 apps from scratch?',
					answer: 'No. We keep working logic and refactor only what blocks production.',
				},
				{
					question: 'How long does v0-to-production take?',
					answer: 'Most projects complete in about one week.',
				},
				{
					question: 'Can you deploy to my existing cloud account?',
				...
				{
					question: 'What if my app needs major changes?',
					answer: 'We explain options clearly before proceeding.',
				},
			],

			// CTA Section
			ctaHeadline: 'Ready to Take Your v0 App to Production?',
			ctaSubtext: 'Let\'s talk. Share your v0 project, codebase, and launch goals. We\'ll map the fastest path to a production-ready release—without losing momentum.',
			ctaButton: 'Get Started',
			secondaryCtaButton: 'Make My v0 App Production-Ready',
		},
		zh: {
			slug: 'from-v0-to-production',
	...
	'from-replit-to-production': {
		en: {
			...
			metaTitle: 'From Replit to Production | Make Your Replit App Production-Ready',
			metaDescription: 'Turn your Replit-built apps into secure, scalable, production-ready products. VibeToLive.dev helps founders make Replit apps production-ready—without rewrites, fragile systems, or launch risk.',
			metaKeywords: ['Replit', 'Replit app', 'production-ready', 'Replit to production', 'AI apps', 'production deployment'],
			featuredImage: '/img3.png',

			// Hero Section
			pageTitle: 'From Replit to Production — Make Your Replit App Production-Ready',
			heroTitle: 'From Replit to Production — Make Your Replit App Production-Ready',
			heroSubtitle: 'Replit helps you build and iterate fast. Production requires stability. VibeToLive.dev helps founders turn Replit-built apps into secure, scalable, production-ready products—without rewrites, fragile systems, or launch risk.',
			heroImage: '/img3.png',
			showTechIcons: true,
			ctaLink: '#pricing',
			secondaryCtaLink: 'https://tally.so/r/mVry2j',
			...
			faqList: [
				{
					question: 'Do you rewrite Replit apps from scratch?',
					answer: 'No. We preserve working logic and fix only what blocks production.',
				},
				{
					question: 'How long does Replit-to-production take?',
					answer: 'Most projects complete in about one week.',
				},
				{
					question: 'Can you deploy to my existing cloud account?',
				...
				{
					question: 'What if my Replit app needs major changes?',
					answer: 'We explain risks and options clearly before proceeding.',
				},
			],

			// CTA Section
			ctaHeadline: 'Ready to Make Your Replit App Production-Ready?',
			ctaSubtext: 'Let\'s talk. Share your Replit app, repo, and launch timeline. We\'ll identify risks, recommend the right path, and help you ship confidently.',
			ctaButton: 'Get Started',
			secondaryCtaButton: 'Make My Replit App Production-Ready',
		},
		zh: {
			slug: 'from-replit-to-production',
	...
	'from-bolt-to-production': {
		en: {
			...
			metaTitle: 'From Bolt to Production | Make Your Bolt App Production-Ready',
			metaDescription: 'Turn your Bolt-built apps into secure, scalable, production-ready products. VibeToLive.dev helps founders make Bolt apps production-ready—without rewrites, fragile logic, or launch risk.',
			metaKeywords: ['Bolt', 'Bolt app', 'production-ready', 'Bolt to production', 'AI apps', 'production deployment'],
			featuredImage: '/img3.png',

			// Hero Section
			pageTitle: 'From Bolt to Production — Make Your Bolt App Production-Ready',
			heroTitle: 'From Bolt to Production — Make Your Bolt App Production-Ready',
			heroSubtitle: 'Bolt helps you move fast from idea to working app. Production demands stability. VibeToLive.dev helps founders turn Bolt-built apps into secure, scalable, production-ready products—without rewrites, fragile logic, or launch risk.',
			heroImage: '/img3.png',
			showTechIcons: true,
			ctaLink: '#pricing',
			secondaryCtaLink: 'https://tally.so/r/mVry2j',
			...
			faqList: [
				{
					question: 'Do you rewrite Bolt apps from scratch?',
					answer: 'No. We preserve working logic and refactor only what blocks production.',
				},
				{
					question: 'How long does Bolt-to-production take?',
					answer: 'Most projects complete in about one week.',
				},
				{
					question: 'Can you deploy to my existing cloud account?',
				...
				{
					question: 'What if my Bolt app needs major changes?',
					answer: 'We explain risks and options clearly before proceeding.',
				},
			],

			// CTA Section
			ctaHeadline: 'Ready to Make Your Bolt App Production-Ready?',
			ctaSubtext: 'Let\'s talk. Share your Bolt project, codebase, and launch goals. We\'ll map the fastest path to a production-ready release—without slowing you down.',
			ctaButton: 'Get Started',
			secondaryCtaButton: 'Make My Bolt App Production-Ready',
		},
		zh: {
			slug: 'from-bolt-to-production',
	...
	'from-cursor-to-production': {
		en: {
			...
			metaTitle: 'From Cursor to Production | Make Your Cursor App Production-Ready',
			metaDescription: 'Turn your Cursor-built apps into secure, scalable, production-ready products. VibeToLive.dev helps founders make Cursor apps production-ready—without rewrites, fragile systems, or launch risk.',
			metaKeywords: ['Cursor', 'Cursor app', 'production-ready', 'Cursor to production', 'AI apps', 'production deployment'],
			featuredImage: '/img3.png',

			// Hero Section
			pageTitle: 'From Cursor to Production — Make Your Cursor App Production-Ready',
			heroTitle: 'From Cursor to Production — Make Your Cursor App Production-Ready',
			heroSubtitle: 'Cursor helps you write code faster with AI assistance. Production requires discipline. VibeToLive.dev helps founders turn Cursor-built apps into secure, scalable, production-ready products—without rewrites, fragile systems, or launch risk.',
			heroImage: '/img3.png',
			showTechIcons: true,
			ctaLink: '#pricing',
			secondaryCtaLink: 'https://tally.so/r/mVry2j',
			...
			faqList: [
				{
					question: 'Do you rewrite Cursor apps from scratch?',
					answer: 'No. We keep working logic and refactor only what blocks production.',
				},
				{
					question: 'How long does Cursor-to-production take?',
					answer: 'Most projects complete in about one week.',
				},
				{
					question: 'Can you deploy to my existing cloud account?',
				...
				{
					question: 'What if my Cursor app needs major changes?',
					answer: 'We explain risks and options clearly before proceeding.',
				},
			],

			// CTA Section
			ctaHeadline: 'Ready to Make Your Cursor App Production-Ready?',
			ctaSubtext: 'Let\'s talk. Share your Cursor project, codebase, and launch timeline. We\'ll identify risks, recommend the right path, and help you ship with confidence.',
			ctaButton: 'Get Started',
			secondaryCtaButton: 'Make My Cursor App Production-Ready',
		},
		zh: {
			slug: 'from-cursor-to-production',
