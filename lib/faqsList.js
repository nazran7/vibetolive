  ...
  FAQ_EN: [
    {
      ...
      answer:
        "No. We remediate what's required to ship (Vibe → Live) or what's in the agreed enhancement scope (Add Some Spice). Anything bigger becomes a separate project. We focus on targeted fixes to get your AI-generated code production-ready, not complete rewrites.",
    },
    {
      question: "What clouds do you support?",
      answer:
    ...
    {
      question: "Will you monitor my app after launch?",
      answer:
    ...
    {
      question: "How long does the Vibe → Live process take?",
      answer:
        "Approximately 1 work week (5 business days) from intake completion & access granted. This includes rapid codebase audit, minimal remediation, security configuration, and deployment to your chosen cloud target.",
    },
    {
      question: "What's the difference between Vibe → Live and Add Some Spice?",
      answer:
    ...
    {
      question: "Do you work with any programming language or framework?",
      answer:
        "We work with most modern web technologies and frameworks. During our initial consultation, we'll review your tech stack to confirm compatibility and identify any potential issues before starting the engagement.",
    },
    {
      question: "What if my AI-generated code has major security vulnerabilities?",
      answer:
    ...
    {
      question: "Can you help with databases and data migrations?",
      answer:
    ...
    },
    {
      ...
      answer:
        "For Vibe → Live and Add Some Spice, we provide documentation and basic rollback procedures. For ongoing support and hotfix deployment, you'll need the Keep It Alive maintenance plan, which includes priority support and next-business-day response.",
    },
    {
      question: "Do you provide training or handoff documentation?",
      answer:
